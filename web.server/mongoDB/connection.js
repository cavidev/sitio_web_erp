...
var readJsonFile = function () {
    ...
    var connectionParams = fs.readFileSync('C:\\Users\\dell\\Documents\\@Aplicaciones Web _Node_\\Exam -Web Elective\\web.server\\mongoDB\\dbConfiguration.json');
    //
    var dbConfig = {}
    try {
        // se convierte a JSON
...
exports.updateDocument = function updateDocument(params, callback) {
    ...
    MongoClient.connect(dbUrl, function (err, db) {
        ...
        collection.updateOne(params.findQuery, params.updateQuery, {
            upsert: true
        }, function (err, result) {
            var res
